...
# print(f"The root mean squared error for Linear Regression model is : {lin_rmse}")
...
# print(f"The root mean squared error for Decision Tree Regressor model is : {dec_rmses}")
...
# print(f"The root mean squared error for Random Forest Regressor model is : {random_forest_rmse}")
